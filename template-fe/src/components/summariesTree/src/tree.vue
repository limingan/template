...
<script>
  ...
  export function getTree() {
    return request({
      url: '/api/cmssummarytype/getTree.do_',
      headers: {
  ...
  export function saveNode(node) {
    return request({
      url: '/api/cmssummarytype/save.do_',
      headers: {
        'content-type': 'application/json'
      },
      method: 'post',
  ...
  export function updateNode(node) {
    return request({
      url: '/api/cmssummarytype/update.do_',
      headers: {
        'content-type': 'application/json'
      },
      method: 'post',
  ...
  export function deleteNode(nodeId) {
    return request({
      url: '/api/cmssummarytype/delete/' + nodeId + '.do_',
      method: 'get'
    })
  }
  export default {
